...

{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            GameScene.AddGameObject(new Head(textures["head_right"], new Vector2(0, graphics.PreferredBackBufferHeight / 2)));
            GameScene.AddGameObject(new Apple(textures["apple_texture"], new Vector2(0 + 160, graphics.PreferredBackBufferHeight / 2)));
        }
